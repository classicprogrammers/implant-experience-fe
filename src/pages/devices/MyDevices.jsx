                            ...
                            <div className="device-info-content">
                                <div className="device-details-left">
                                    <div className="info-item">
                                        ...
                                        <span className="info-value-text">Boston Scientific Precision Plus</span>
                                    </div>
                                    <div className="info-item">
                                ...
                                <div className="device-details-right">
                                    <div className="info-item">
                                        ...
                                        <span className="info-value">September 21, 2024</span>
                                    </div>
                                    <div className="info-item">
                                        <span className="info-label">Heath Provider</span>
                                        <span className="info-value">Dr. Jennifer</span>
                                    </div>
                                    <div className="info-item">
                                        <span className="info-label">Last Safety Check</span>
                                        <span className="info-value">January 05, 2025</span>
                                    </div>
                                </div>
                            </div>
                        </div>
